          ...
          <div className="mt-12 space-y-6">
            ...
            <div>
              <button
                ...
                className="w-full py-2 px-4 text-[15px] font-medium rounded-md text-white button-primary  focus:outline-none"
              >
                {tSignUp('signupButton')}
              </button>
              <p className="text-center mt-1 text-gray-800 text-md">
                {tSignUp('accountLabelOne')}
                <span className="font-semibold hover:text-[#d00000] cursor-pointer px-1">
